...
for u in us:
    ...
    for i in range(num_runs):
        ...
        tem_results.append((len(activation_time), step))
    ...
    sweeping_results[u] = (sizes, rates)

Data_Root = '/auto/rcf-proj/ef/hp_273/Diffusion/SBM/'

with open(Data_Root + 'phase_simu_nodes_%sk_z_%s_rho0_%s_f_%s_%s.pickle'%(num_nodes//1000, avg_degree, rho, f, SLURM_PROCID), 'wb') as file:
